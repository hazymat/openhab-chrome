document.addEventListener('DOMContentLoaded',
    function applysettings() {
        document.getElementById('MyFrameContainer').innerHTML = '<iframe style="border:none;" src="' + localStorage["local_server_id"] + localStorage["path_id"] + '" width=100% height=100%></iframe>';
